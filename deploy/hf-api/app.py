...
# In the HF Space repo, PKL files live at: models/churn_model_optimized.pkl
OPTIMIZED_MODEL = Path("models/churn_model_optimized.pkl")
BASE_MODEL = Path("models/churn_model.pkl")
